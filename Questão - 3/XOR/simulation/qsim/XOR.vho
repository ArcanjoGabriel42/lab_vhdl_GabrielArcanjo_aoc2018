...
SIGNAL \G4|pout~0_combout\ : std_logic;
...
\G4|pout~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \G4|pout~0_combout\ = !\Input_a~input_o\ $ (!\Input_b~input_o\)
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Input_a~input_o\,
	datab => \ALT_INV_Input_b~input_o\,
	combout => \G4|pout~0_combout\);
